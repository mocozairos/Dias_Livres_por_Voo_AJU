...
def puxar_dados_phoenix():
    ...
    st.session_state.df_sales = gerar_df_sales('test_phoenix_aracaju')
    ...
    st.session_state.df_router_2 = gerar_df_router('test_phoenix_aracaju')
...
st.title('Aproveitamento Dias Livres - Aracajú')
